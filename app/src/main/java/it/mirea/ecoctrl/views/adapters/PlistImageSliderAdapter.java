...
public class PlistImageSliderAdapter extends RecyclerView.Adapter<PlistImageSliderAdapter.ImageSliderViewHolder> {
    List<String> images;
    PlistActivity mActivity;

    public PlistImageSliderAdapter(List<String> images, boolean adding, PlistActivity activity) {
        this.images = images;
        mActivity = activity;
    ...
    @NotNull
    @Override
    public PlistImageSliderAdapter.ImageSliderViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        return new PlistImageSliderAdapter.ImageSliderViewHolder(ImageElementBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull PlistImageSliderAdapter.ImageSliderViewHolder holder, int position) {
